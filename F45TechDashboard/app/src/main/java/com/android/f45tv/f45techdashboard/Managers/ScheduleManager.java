package com.android.f45tv.f45techdashboard.Managers;
...
public class ScheduleManager {
    ...
    private Map<String, ScheduleController> observer;
    ...
    public void putObserver(String key, ScheduleController tableController)
    {
        observer.put(key, tableController);
    }


    public void notifyObserver(ArrayList<ScheduleDataModel> dataModel)
    {
        ScheduleDataModel deputyDataModel;
        ...
        if (dataModel != null)
        {
            ...
            {
                for (Map.Entry<String, ScheduleController> shiftTableController : observer.entrySet())
                {
